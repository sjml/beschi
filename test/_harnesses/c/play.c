...
static beschi_TestingMessage example;
...
int main() {
    ...
    example.v2l_len = 4;
    beschi_Vec2 v21 = { .x = 10.0f, .y = 15.0f };
    beschi_Vec2 v22 = { .x = 20.0f, .y = 25.0f };
    beschi_Vec2 v23 = { .x = 30.0f, .y = 35.0f };
    beschi_Vec2 v24 = { .x = 40.0f, .y = 45.0f };
    beschi_Vec2 v2l[4] = { v21, v22, v23, v24 };
    example.v2l = v2l;

    example.v3l_len = 4;
    beschi_Vec3 v31 = { .x = 10.0f, .y = 15.0f, .z = 17.5f };
    beschi_Vec3 v32 = { .x = 20.0f, .y = 25.0f, .z = 27.5f };
    beschi_Vec3 v33 = { .x = 30.0f, .y = 35.0f, .z = 37.5f };
    beschi_Vec3 v34 = { .x = 40.0f, .y = 45.0f, .z = 47.5f };
    beschi_Vec3 v3l[4] = { v31, v32, v33, v34 };
    example.v3l = v3l;

    example.cl_len = 3;
    beschi_Color c1 = { .r = 255, .g = 0, .b = 0 };
    beschi_Color c2 = { .r = 0, .g = 255, .b = 0 };
    beschi_Color c3 = { .r = 0, .g = 0, .b = 255 };
    beschi_Color cl[3] = { c1, c2, c3 };
    example.cl = cl;
    ...
    cx.textColor = c2;
    cx.spectrum_len = 3;
    beschi_Color cx_spectrum[3] = {c3, c2, c1};
    cx.spectrum = cx_spectrum;
    example.cx = cx;

    beschi_ComplexData cx1;
    cx1.identifier = 255;
    cx1.label = "Complex1";
    ...
    cx1.textColor = c1;
    cx1.spectrum_len = 5;
    beschi_Color cx1_spectrum[5] = { c3, c2, c1, c2, c3 };
    cx1.spectrum = cx1_spectrum;

    beschi_ComplexData cx2;
    cx2.identifier = 63;
    cx2.label = "Complex2";
    ...
    cx2.textColor = c3;
    cx2.spectrum_len = 5;
    beschi_Color cx2_spectrum[5] = { c1, c2, c3, c2, c1 };
    cx2.spectrum = cx2_spectrum;

    beschi_ComplexData cxl[2] = { cx1, cx2 };
    example.cxl_len = 2;
    example.cxl = cxl;


    size_t bufferSize;
    beschi_err_t err = beschi_TestingMessage_GetSizeInBytes(&example, &bufferSize);
    BESCHI_ERR_CHECK_RETURN;

    uint8_t* buffer = malloc(bufferSize);
    beschi_DataAccess writer = {.buffer = buffer, .bufferSize = bufferSize, .position = 0};
    err = beschi_TestingMessage_WriteBytes(&writer, &example, false);
    ...
    beschi_TestingMessage* input = malloc(sizeof(beschi_TestingMessage));
    err = beschi_TestingMessage_FromBytes(&reader, input);

    softAssert(err == BESCHI_ERR_OK, "parsing test message");
    ...
    beschi_TestingMessage_Destroy(input);
